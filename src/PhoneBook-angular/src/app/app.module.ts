...
import { CreateOrEditPersonModelComponent } from './persons/create-or-edit-person-model/create-or-edit-person-model.component';
...
@NgModule({
    declarations: [
        ...
        PersonsComponent,
        CreateOrEditPersonModelComponent
